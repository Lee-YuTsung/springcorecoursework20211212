...
import com.study.springcore.yutsung.coursework20211212.coursework3.entity.Emp;
...
public class EmpDao{
	...
	//01/09Homework
	public void createLog(String methodName) {
		String sql = "insert into methodlog (name, date) values (?, ?)";
		jdbcTemplate.update(sql, new Object[] {methodName, new Date()});
	}
	public List<Map<String, Object>> queryLog() {
		String sql = "select logid, name, date from methodlog";
